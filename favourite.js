...
firebase.auth().onAuthStateChanged(function(user) {
    if (user) {
        ...
        document.getElementById(`suh`).innerHTML = `Products in Cart`
     ...
     <div class="cardstyling col-lg-4 col-sm-6 portfolio-item">
       <div class="card h-100">
         ...
         <div class="card-body">
           ...
           <h5>${data.price}</h5>
           <button type="button" class="btn btn-danger" onclick="deleteFavourite('${key}',this)">Remove From Cart</button>
         </div>
       </div>
     </div>
    `
...
function fetchFavourites() {
    ...
    fetch(`https://olx-pakistan-8800e.firebaseio.com/favourites/${userId}.json`)
        ...
        .then(data2 => {
            ...
            document.getElementById(`cartTotal`).innerHTML = "Total = " + a
